...
// include: /tmp/tmpu8gzf765.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'out_wasm/index.data';
...
Module['FS_createPath']("/src", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_out_wasm/index.data');

      };
      Module['addRunDependency']('datafile_out_wasm/index.data');
    ...
    loadPackage({"files": [{"filename": "/src/resources/image.png", "start": 0, "end": 110610}], "remote_package_size": 110610});

  })();

// end include: /tmp/tmpu8gzf765.js
// include: /tmp/tmpt2ddczop.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpt2ddczop.js
// include: /tmp/tmpznd2ucuo.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpznd2ucuo.js
...
var ASM_CONSTS = {
  67133904: () => { if (document.fullscreenElement) return 1; },  
 67133950: () => { return document.getElementById('canvas').width; },  
 67134002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 67134070: () => { document.exitFullscreen(); },  
 67134097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 67134170: () => { if (document.fullscreenElement) return 1; },  
 67134216: () => { return document.getElementById('canvas').width; },  
 67134268: () => { return screen.width; },  
 67134293: () => { document.exitFullscreen(); },  
 67134320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 67134453: () => { return window.innerWidth; },  
 67134479: () => { return window.innerHeight; },  
 67134506: () => { if (document.fullscreenElement) return 1; },  
 67134552: () => { return document.getElementById('canvas').width; },  
 67134604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 67134672: () => { if (document.fullscreenElement) return 1; },  
 67134718: () => { return document.getElementById('canvas').width; },  
 67134770: () => { return screen.width; },  
 67134795: () => { return window.innerWidth; },  
 67134821: () => { return window.innerHeight; },  
 67134848: () => { if (document.fullscreenElement) return 1; },  
 67134894: () => { return document.getElementById('canvas').width; },  
 67134946: () => { return screen.width; },  
 67134971: () => { document.exitFullscreen(); },  
 67134998: () => { if (document.fullscreenElement) return 1; },  
 67135044: () => { return document.getElementById('canvas').width; },  
 67135096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 67135164: () => { document.exitFullscreen(); },  
 67135191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 67135249: () => { return screen.width; },  
 67135274: () => { return screen.height; },  
 67135300: () => { return window.screenX; },  
 67135327: () => { return window.screenY; },  
 67135354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 67135407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 67135478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 67135535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 67135791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 67135862: () => { if (document.fullscreenElement) return 1; },  
 67135908: () => { return window.innerWidth; },  
 67135934: () => { return window.innerHeight; },  
 67135961: () => { if (document.pointerLockElement) return 1; }
};
